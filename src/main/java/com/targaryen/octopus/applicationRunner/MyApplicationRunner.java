...
public class MyApplicationRunner implements ApplicationRunner {
    ...
    private static final String INSERT_SQL =
            "INSERT INTO t_batch (batch_id, batch_name, number, start_time, year) VALUES (1, '2018 Autumn', 2, '2018-09-01', '2018-01-01');\n" +
                    ...
                    "INSERT INTO t_post (post_id, interview_round, post_description, post_locale, post_name, post_requirement, post_type, publish_time, recruit_num, recruit_type, status, batch_id, department_id) VALUES (1, 1, 'Java Developer', 'Shanghai', 'Java Developer', 'Java', 'R&D', '2018-09-01', 30, 0, 1, 1, 1) ON conflict(post_id) DO NOTHING;\n" +
